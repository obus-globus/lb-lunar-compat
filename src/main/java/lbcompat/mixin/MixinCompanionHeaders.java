...
/**
 * Serves the Headers companion LiquidBounce reads, for a host bundling an okhttp older than 4.0.
 *
...
public abstract class MixinCompanionHeaders {

    @Redirect(
        method = "*",
        at = @At(value = "FIELD", target = "Lokhttp3/Headers;Companion:Lokhttp3/Headers$Companion;", opcode = Opcodes.GETSTATIC),
        require = 0
    )
