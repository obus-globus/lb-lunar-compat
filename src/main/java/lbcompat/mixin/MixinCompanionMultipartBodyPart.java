...
/**
 * Serves the MultipartBody$Part companion LiquidBounce reads, for a host bundling an okhttp older than 4.0.
 *
...
public abstract class MixinCompanionMultipartBodyPart {

    @Redirect(
        method = "*",
        at = @At(value = "FIELD", target = "Lokhttp3/MultipartBody$Part;Companion:Lokhttp3/MultipartBody$Part$Companion;", opcode = Opcodes.GETSTATIC),
        require = 0
    )
